  ...
  return (
      <div className="max-w-7xl w-full p-4 md:p-8 mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              <div
                  className="col-span-1 lg:col-span-2 h-full bg-gray-200/60 min-h-[500px] lg:min-h-[300px] rounded-2xl p-8">
                  <h1 className="text-3xl lg:text-6xl font-medium">Hey I am Adarsh ⭐</h1>
          ...
          <span
            ...
            <span className="relative">Get in Touch!</span>
              ...
              <div className="relative col-span-1 object-cover rounded-2xl bg-gray-200/60">
                  <div
                      className="relative flex h-full w-full max-w-[32rem] items-center justify-center overflow-hidden rounded-lg border bg-background p-20 md:shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-10">
              <div className="w-full relative col-span-1 h-full">
                  <BackgroundGradientAnimation>
                      <div
                          className="absolute inset-0 flex items-center justify-center text-white font-bold px-4 text-2xl text-center md:text-3xl lg:text-5xl z-50">
                          <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-10">
              <Card className="col-span-1 lg:col-span-2 border-none bg-gray-200/60 p-10 flex flex-col">
                  ...
                  <p className="mt-8 text-muted-foreground lg:text-lg">
                      ...
                      solutions and continuously improve my skills to stay up-to-date in the
